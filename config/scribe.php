...
return [
    ...
    'title' => 'OUAGA CHAP API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST pour l\'application de livraison OUAGA CHAP - Livraison rapide à Ouagadougou',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenez votre token en envoyant un OTP via `/api/v1/auth/send-otp` puis en le vérifiant via `/api/v1/auth/verify-otp`.',
    ],
