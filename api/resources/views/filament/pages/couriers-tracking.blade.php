<x-filament-panels::page>
    <div class="space-y-6">
        {{-- Leaflet CSS + Google Maps styles --}}
        @push('styles')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2" wire:ignore>
                <div
                    ...
                    <div
                        class="p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-slate-800 to-slate-900">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="flex items-center gap-2 px-3 py-1.5 rounded-full bg-red-500 text-white text-sm font-bold animate-pulse">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex flex-wrap items-center gap-6">
                            ...
                            <div class="flex items-center gap-2"><span class="text-xl">🏍️</span><span
                                    class="text-sm text-gray-600 dark:text-gray-300">Moto</span></div>
                            <div class="flex items-center gap-2"><span class="text-xl">🚲</span><span
                                    class="text-sm text-gray-600 dark:text-gray-300">Vélo</span></div>
                            <div class="flex items-center gap-2"><span class="text-xl">🚗</span><span
                                    class="text-sm text-gray-600 dark:text-gray-300">Voiture</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-1">
                <div
                    class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 h-full">
                        ...
                        @forelse($this->getCouriers() as $courier)
                            <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer"
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="relative flex-shrink-0">
                                        <div
                                            class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 text-xl shadow-lg">
                                        ...
                                        <span class="absolute -bottom-1 -right-1 flex h-4 w-4">
                                            <span
                                                class="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-75"></span>
                                            <span
                                                class="relative inline-flex h-4 w-4 rounded-full bg-emerald-500 border-2 border-white dark:border-gray-800"></span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex flex-col items-end gap-1">
                                        <span
                                            class="inline-flex items-center text-xs font-medium text-amber-600 bg-amber-100 px-2 py-0.5 rounded-full">⭐
                                            {{ $courier['rating'] }}</span>
                            ...
                            @empty
                                <div class="p-8 text-center">
                                    ...
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">Aucun coursier en ligne
                                    </h4>
                        ...
                        function loadMarkers() {
                            ...
                            try {
                                ...
                                data.forEach(function(c) {
                                    var emoji = c.vehicle === 'moto' ? '🏍️' : c.vehicle === 'velo' ? '🚲' : c.vehicle ===
                                        'voiture' ? '🚗' : '🛵';
                                    var icon = L.divIcon({
                                        className: 'courier-marker',
                                        html: '<div style="font-size:32px;filter:drop-shadow(0 2px 4px rgba(0,0,0,.3))">' +
                                            emoji + '</div>',
                                        iconSize: [40, 40],
                                        iconAnchor: [20, 20]
                                    });
                                ...
                                if (data.length > 0) {
                                    var bounds = L.latLngBounds(data.map(function(c) {
                                        return [c.lat, c.lng];
                                    }));
