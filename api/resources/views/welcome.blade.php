...
<head>
    ...
    <meta name="description"
        content="OUAGA CHAP - Service de livraison rapide à Ouagadougou, Burkina Faso. Livraison de colis, courses et repas en moins de 30 minutes.">
    ...
    <meta property="og:description"
        content="Service de livraison express à Ouagadougou. Commandez et recevez vos colis en moins de 30 minutes.">
                                    ...
                                    <div
                                        ...
                                        <div class="text-white text-center mb-6">
                                            <div
                                                ...
                                                <img src="{{ asset('images/logo-ouagachap.png') }}" alt="Logo"
                                        ...
                                        <div class="bg-white rounded-xl p-4 shadow-lg mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <span class="text-gray-400 text-sm">Entrez l'adresse de
                                                    livraison...</span>
                                            </div>
                                        </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="feature-card bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl" data-aos="fade-up">
                    ...
                    <p class="text-gray-600">
                        Vos colis livrés en moins de 30 minutes partout à Ouagadougou. Notre réseau de coursiers est
                        prêt 24h/24.
                    </p>
                </div>
                ...
                <div class="feature-card bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl" data-aos="fade-up"
                    ...
                    <p class="text-gray-600">
                        Suivez votre coursier sur la carte en temps réel. Vous savez exactement où se trouve votre
                        colis.
                    </p>
                </div>
                ...
                <div class="feature-card bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl" data-aos="fade-up"
                    ...
                    <p class="text-gray-600">
                        Payez par Mobile Money (Orange Money, Moov Money) ou en espèces à la livraison. Simple et
                        sécurisé.
                    </p>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition" data-aos="fade-up">
                    ...
                    <a href="#download"
                        class="block text-center bg-gray-100 text-gray-800 py-3 rounded-xl font-semibold hover:bg-gray-200 transition">
                        Commander
                    </a>
                </div>

                <!-- Popular -->
                <div class="bg-primary-500 rounded-2xl p-8 shadow-xl relative transform md:-translate-y-4"
                    ...
                    <a href="#download"
                        class="block text-center bg-white text-primary-600 py-3 rounded-xl font-semibold hover:bg-gray-100 transition">
                        Commander
                    </a>
                </div>
                ...
                <div data-aos="fade-right">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ config('app.store_links.coursier.google_play', '#') }}"
                            ...
                            class="inline-block hover:opacity-80 transition">
                            <img src="https://play.google.com/intl/en_us/badges/static/images/badges/fr_badge_web_generic.png"
                                alt="Disponible sur Google Play" class="h-12">
                        </a>
                        <a href="{{ config('app.store_links.coursier.app_store', '#') }}"
                            target="_blank" rel="noopener"
                            class="inline-block hover:opacity-80 transition">
                            <img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg"
                                alt="Télécharger sur l'App Store" class="h-12">
                        </a>
                    </div>
                </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition" data-aos="fade-up">
                    ...
                    <p class="text-gray-600 mb-6">
                        "Service excellent! J'ai fait livrer des documents urgents en 20 minutes. Le coursier était très
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition" data-aos="fade-up"
                    ...
                    <p class="text-gray-600 mb-6">
                        "En tant que coursier, je gagne bien ma vie avec OUAGA CHAP. Les paiements sont rapides et
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition" data-aos="fade-up"
                    ...
                    <p class="text-gray-600 mb-6">
                        "J'utilise OUAGA CHAP pour mon restaurant. Mes clients reçoivent leurs commandes encore chaudes.
                        C'est génial!"
                    </p>
                    <div class="flex items-center gap-3">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center" data-aos="fade-up">
                ...
                <p class="text-gray-400 max-w-2xl mx-auto mb-12">
                    Disponible sur Google Play et l'App Store. Téléchargez OUAGA CHAP et commencez à livrer ou commander.
                </p>
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="hover:text-white transition">Politique de confidentialité</a>
                        </li>
