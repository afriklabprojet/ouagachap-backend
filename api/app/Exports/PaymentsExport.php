...
class PaymentsExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
    ...
    public function map($payment): array
    {
        return [
            ...
            $this->formatProvider($payment->provider instanceof \BackedEnum ? $payment->provider->value : $payment->provider),
            $payment->phone_number ?? 'N/A',
            $this->formatStatus($payment->status instanceof \BackedEnum ? $payment->status->value : $payment->status),
