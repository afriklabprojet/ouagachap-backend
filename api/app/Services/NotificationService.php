...
class NotificationService
{
    ...
    /**
     * Envoyer une notification push directe (sans type NotificationType)
     * Utilisée par les webhooks et services externes
     */
    public function sendToUser(User $user, string $title, string $body, array $data = []): bool
    {
        ...
        try {
            ...
            Log::error('Erreur sendToUser notification: ' . $e->getMessage(), [
                'user_id' => $user->id,
            ]);
            return false;
        }
