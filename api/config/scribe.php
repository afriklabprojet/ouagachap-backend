...
// Scribe est un package dev-only. Ce fichier est ignoré en production.
...
return [
    ...
    'description' => 'API de la plateforme OUAGA CHAP — livraison de repas à Ouagadougou. Gestion des commandes, paiements, suivi en temps réel et notifications.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authentification via Laravel Sanctum. Envoyez le header `Authorization: Bearer {token}` obtenu via `POST /api/v1/auth/login`.',
    ],
